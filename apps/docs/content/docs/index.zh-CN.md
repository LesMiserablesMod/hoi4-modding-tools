...
description: 面向 Hearts of Iron IV Mod 开发者的工具与资料索引。
---

HOI4 Modding Tools 是一个面向 Hearts of Iron IV Mod 开发者的工具、资料、编辑器、脚本、校验器与参考资源索引。
...
- [工具目录](/zh-CN/docs/catalog) - 按 HOI4 Mod 开发流程分类的工具目录。
- [资料索引](/zh-CN/docs/resources) - 官方链接、社区指南与教程。
- [参与贡献](/zh-CN/docs/contribute) - 如何推荐工具、更新条目和贡献代码。

## 协议摘要

文档、工具目录、示例与网站内容采用 **CC BY-NC-SA 4.0** 协议。
