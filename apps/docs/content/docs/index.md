...
description: A curated collection of tools and resources for Hearts of Iron IV mod development.
---

HOI4 Modding Tools is a curated collection of tools, resources, editors, scripts, validators, and references for Hearts of Iron IV mod development.

The project is maintained by the **LesMiserablesMod** community. It helps HOI4 modders discover useful tools, compare their use cases, and build a more reliable modding workflow.
...
Documentation, catalog entries, examples, and website content are licensed under **CC BY-NC-SA 4.0**.
